...
#include "LDHT.h"
#define WIFI_AP "cs15"
#define WIFI_PASSWORD "0935312313"
#define WIFI_AUTH LWIFI_WPA  // choose from LWIFI_OPEN, LWIFI_WPA, or LWIFI_WEP.
#define per 50
#define per1 3
#define DEVICEID "D8oftSSU" // Input your deviceId
#define DEVICEKEY "tNq8RARy1CZ0Agap" // Input your deviceKey
...
void uploadstatus(){
  ...
  delay(100);
  upload_led = "Temp_Display,,"+String(dht.readTemperature())+"\n"+"Hum_Display,,"+String(dht.readHumidity());
